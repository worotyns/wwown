...
import { ConcreteResourceData, ConcreteResourceDataParams } from "../../../domain/stats/concrete_resource_data.ts";
import { Activity, HourPercentDistribution, LastChannels, TopChannels } from "../../interfaces.ts";
