const emojisResponse = await fetch("https://raw.githubusercontent.com/iamcal/emoji-data/master/emoji.json")
const emojis = await emojisResponse.json()

const wrappedEmojis = emojis.reduce((result: Record<string, string>, emoji: Record<string, string>) => {
